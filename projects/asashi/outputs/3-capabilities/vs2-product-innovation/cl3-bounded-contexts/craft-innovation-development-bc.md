...
| 項目 | 内容 |
|------|------|
| **BC名** | craft-innovation-development-bc |
| **日本語名** | クラフト・革新開発 |
| **命名パターン** | `-innovation-development`（価値創造型 + 変革型） |
| **命名理由** | 「innovation」を含めることで既存製品改良ではなく**新規性・革新性**を強調。クラフトビール、ノンアルコール、低糖質等の市場創造型の取り組みを表現。「製品管理」ではなく「革新開発」で破壊的創造を意図 |
