...
```
CL1: スキル開発ドメイン（Why: なぜ必要か）
    ↓
CL2: スキル評価サブドメイン（What: 何をするか）
    ↓
CL3: 評価実施オペレーション（How: どう実施するか）
    - 評価申込受付
    - 評価問題配信
    - 回答収集
    - 採点処理
...
━━━━━━━━━━━━━━━━━━━━━
 WHAT: 価値（何を実現したいか）
  ↓ 行き詰まったらHOWへ
 HOW: Value Stream（どう流れるか）
  ↓ 新しいWHATが見える

Level 2: サービス層  
━━━━━━━━━━━━━━━━━━━━━
 WHAT: Capability（何が必要か）
  ↓ 行き詰まったらHOWへ
 HOW: Service設計（どう分割するか）
  ↓ 新しいWHATが見える

Level 3: 実装層
━━━━━━━━━━━━━━━━━━━━━
 WHAT: Software設計（何を作るか）
  ↓ 行き詰まったらHOWへ
 HOW: 実装（どう作るか）
```
