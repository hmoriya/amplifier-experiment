#!/usr/bin/env python3
"""
Perfect ultimate Parasol V5 book generator
"""

import re
import json
from pathlib import Path
from complete_markdown_converter import CompleteMarkdownConverter


class PerfectUltimateBookGenerator:
    """Perfect ultimate book generator"""
    
    def __init__(self, book_dir: Path, output_dir: Path):
        self.book_dir = Path(book_dir)
        self.output_dir = Path(output_dir)
        self.output_dir.mkdir(exist_ok=True)
        self.converter = CompleteMarkdownConverter()
    ...
    def generate_html(self):
        """Generate HTML book"""
        print("📚 Perfect Ultimate Parasol V5 Book Generator")
        print("=" * 50)
        ...
        # Save
        output_file = self.output_dir / 'parasol-v5-complete.html'
        output_file.write_text(html, encoding='utf-8')
        
        print(f"\n✅ Perfect HTML book: {output_file}")
    ...
    def save_metadata(self, chapters):
        ...
        metadata = {
            ...
            "features": [
                ...
                "Mermaid flow diagram support",
                "Syntax highlighting",
                "Responsive design",
                "Print optimization",
                "Perfect code block handling",
...
def main():
    """Main function"""
    generator = PerfectUltimateBookGenerator(
