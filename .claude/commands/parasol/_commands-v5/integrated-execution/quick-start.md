---
description: Quick project start with MS1 achievement (project:parasol)
---

# /parasol:quick-start - 高速プロジェクト開始

ワンコマンドでMS1（コンテキスト確立）まで達成する統合実行コマンド
...
新規プロジェクトを**1週間以内にMS1達成**まで導く高速スタートアップ：
...
5. **ms1-achievement-report.md** - MS1達成レポート
...
- `/parasol:strategic-design` - MS1-MS2の統合実行
- `/parasol:full-design` - MS1-MS3の完全設計
