...
VMS1（価値発見）からVMS3（構造設計）まで一括で実行し、実装可能な完全な設計を生成します。価値から構造まで一貫性を保ちながら、包括的な設計ドキュメントとアーキテクチャを自動生成する統合コマンドです。
...
対話フロー:
VMS1 完了 → レビュー → 承認/修正 → VMS2 実行
VMS2 完了 → レビュー → 承認/修正 → VMS3 実行
VMS3 完了 → 最終レビュー → 設計完了
```
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[VMS1: 価値発見] 10:23:15 - 10:35:42 (12分27秒)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[VMS2: 価値設計] 10:35:45 - 10:53:21 (17分36秒)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[VMS3: 構造設計] 10:53:25 - 11:21:08 (27分43秒)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
2. amplifier parasol:milestone advance    # VMS4へ進行
...
# 特定フェーズの再実行
amplifier parasol:full-design --retry VMS2
