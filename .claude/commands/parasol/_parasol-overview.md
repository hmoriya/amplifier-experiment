...
┃  ├──────────┼──────────┼──────────┼──────────┼──────────┼──────────┤      ┃
┃  │          │  Core:   │  Core:   │  Core:   │          │          │      ┃
┃  │  Core:   │ 製品開発 │ セールス │ 出荷管理 │  Core:   │  Core:   │      ┃
┃  │ マーケ   │    │     │    ↑     │    ↑     │ サポート │ 保守     │      ┃
┃  │ ティング │    └─────┼────┘     │    │     │          │          │      ┃
┃  │          │       参照（製品情報）│  参照    │          │          │      ┃
┃  ├──────────┼──────────┼──────────┼──────────┼──────────┼──────────┤      ┃
┃  │Supporting│Supporting│Supporting│Supporting│Supporting│Supporting│      ┃
┃  │データ基盤│データ基盤│データ基盤│データ基盤│データ基盤│データ基盤│      ┃
┃  │   v1     │   v1     │   v2     │   v2     │   v3     │   v3     │      ┃
┃  │          │          │(顧客追加)│          │(利用追加)│          │      ┃
┃  ├──────────┼──────────┼──────────┼──────────┼──────────┼──────────┤      ┃
┃  │ Generic: │ Generic: │ Generic: │ Generic: │ Generic: │ Generic: │      ┃
┃  │ 認証基盤 │ 認証基盤 │ 認証基盤 │ 認証基盤 │ 認証基盤 │ 認証基盤 │      ┃
┃  │ 経理     │ 経理     │ 経理     │ 経理     │ 経理     │ 経理     │      ┃
┃  └──────────┴──────────┴──────────┴──────────┴──────────┴──────────┘      ┃
┃                                                                             ┃
┃  【凡例】                                                                   ┃
┃  ・Core: 特定VSに紐付く顧客接点活動                                         ┃
┃  ・Supporting: VStr全体を支援（VSごとに進化可能）                           ┃
┃  ・Generic: 組織全体の基盤（VS横断で共通）                                  ┃
┃  ・→: 参照関係（先行VSの成果を後続が利用）                                  ┃
┃                                                                             ┃
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
```
...
| 特性 | 説明 | 例 |
|------|------|-----|
| **時間性** | VSは時間文脈を提供、オペレーションは時間順に配置 | VS2の製品開発 → VS3のセールス |
| **文脈最適化** | 同じCapabilityでもVS文脈で具体Operationが異なる | データ基盤 v1→v2→v3 と進化 |
