...
| レベル | 分解軸 | 定義 | 期間 | アジャイル | Phase |
|--------|--------|------|------|------------|-------|
| **VStr** | 価値の流れ | 顧客価値の全体像 | - | - | 2 |
| **VS** | 時間 | 顧客状態遷移 | - | - | 2 |
| **CL1** | 活動領域 | Core/Supporting/Generic | - | Portfolio | 3 |
| **CL2** | 能力単位 | ケイパビリティ | - | Product | 3 |
| **CL3** | 業務活動 | ビジネスオペレーション | 数日〜数週間 | **Epic/Feature** | 3 |
| **BC** | 活動境界 | API・DB・変更範囲 | - | - | 4 |
| **Actor UC** | 単一操作 | ユーザの完結操作 | 数分〜数時間 | **User Story** | 4-5 |
| **View** | UI画面 | 操作インターフェース | - | **Task** | 5 |
