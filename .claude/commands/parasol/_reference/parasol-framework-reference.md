...
1. **バックキャスティング**: 理想の未来（MS5）から逆算してマイルストーンを設計
...
│  ┌─────────────────────────────────────────────────────────────┐   │
│  │ CL1: Domain → CL2: Capability → CL3: Operation/BC          │   │
│  │                                                             │   │
│  │ 【責務】価値実現に必要な組織能力の構造化                    │   │
│  └─────────────────────────────────────────────────────────────┘   │
├─────────────────────────────────────────────────────────────────────┤
...
| Operation (CL3) | Bounded Context | CL3 が BC の境界を決定 |
...
│ ┌─────────────────────────────────────────────────────────────────┐ │
│ │ 「どんな能力が必要か」の具体化                                  │ │
│ │ 例: 発酵技術研究、消費者インサイト分析、在庫最適化              │ │
│ └─────────────────────────────────────────────────────────────────┘ │
├─────────────────────────────────────────────────────────────────────┤
│ CL3: Operation / Bounded Context（操作/境界づけられたコンテキスト） │
│ ┌─────────────────────────────────────────────────────────────────┐ │
│ │ 「具体的に何をするか」の実装単位                                │ │
...
│  CL1 (Domain)        →    Domain Classification                 │
│  CL2 (Capability)    →    Subdomain                             │
│  CL3 (Operation)     →    Bounded Context (BC)                  │
