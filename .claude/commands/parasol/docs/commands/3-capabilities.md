...
└─────────────────────────────────────────────────────────────────┘
     ...
     ▼
┌─────────────────────────────────────────────────────────────────┐
│ BO: 業務オペレーション (Business Operation) ★CL3のHOW対応         │
│ ─────────────────────────────────────────────────────────────── │
│ 【HOW業務】どう業務遂行するか？                                    │
│ • 対象: 業務担当者・ドメインエキスパート                           │
│ • 目的: CL3の詳細能力を実現する日々の業務活動の定義                │
│ • 構造: トリガー → 活動内容 → 成果物                              │
│ • 粒度: 1日〜1週間で完結する業務単位                              │
│ • 例: 酵母株探索・収集、酵母株育種・改良、発酵パラメータ調整       │
│                                                                 │
│ DDD対応: Use Case / Application Service                          │
└─────────────────────────────────────────────────────────────────┘
     │
     ▼
┌─────────────────────────────────────────────────────────────────┐
...
|------|----------------|-------------------------|
| **領域** | WHAT（何の能力） | HOW（どう遂行） |
| **質問** | 何の詳細能力か？ | どう業務遂行するか？ |
| **対象** | 業務担当者 | 業務担当者 |
| **内容** | 能力の定義 | 業務フロー、トリガー、成果物 |
| **DDD対応** | Sub-domain詳細 | Use Case / Application Service |
