...
│  │     │           │           │            │           │                    │
│  │  最上位価値   価値構造化   構造化価値   マイル定義   バリューステージ      │
│  │     │           │           │            │           │                    │
│  │  [期待を超える] [製品       [発酵技術    [VMS5→VMS1  [VS0-VS7             │
│  │   おいしさ]     イノベ]     による革新]  バックキャスト] 顧客状態]         │
│  └───────────────────────────────────────────────────────────────────────────┘  │
│                                      │                                          │
│                                      ▼                                          │
│  ┌───────────────────────────────────────────────────────────────────────────┐  │
...
│  │                                                                           │  │
│  │  ┌─────────────────┐    ┌──────────┐    ┌─────────────────┐               │  │
│  │  │ Problem Space   │    │ 変換     │    │ Solution Space  │               │  │
│  │  │ (Phase 3)       │───▶│(Phase 4) │───▶│ (Phase 5-6)     │               │  │
│  │  │                 │    │          │    │                 │               │  │
│  │  │ CL1→CL2→CL3    │    │ BC境界   │    │ BC→Service→実装│               │  │
│  │  │                 │    │ 確定     │    │                 │               │  │
│  │  └─────────────────┘    └──────────┘    └─────────────────┘               │  │
│  └───────────────────────────────────────────────────────────────────────────┘  │
│                                                                                 │
