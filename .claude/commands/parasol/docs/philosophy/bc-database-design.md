...
│                                                                              │
│  Stage → CL2（Subdomain = BC境界）→ CL3（詳細能力）→ BO → Service → DB   │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
| 概念 | V5での位置づけ | 領域 | 説明 |
|------|---------------|------|------|
| **Subdomain = BC境界** | **CL2** | WHAT | 詳細能力群を束ねた境界 |
| **Sub-capability** | **CL3** | WHAT | BC内の詳細能力 |
| **Business Operation** | **BO** | HOW | CL3を実現する業務オペレーション |
...
│      │    │                                                            │  │ │
│      │    │    ┌───────────────────────────────────────────────────┐  │  │ │
│      │    │    │  BO: Business Operation（業務OP）【HOW】           │  │  │ │
│      │    │    │       → CL3を実現する業務活動（どう遂行するか）    │  │  │ │
│      │    │    │       → オペレーションA-1                          │  │  │ │
│      │    │    │       → オペレーションA-2                          │  │  │ │
│      │    │    └───────────────────────────────────────────────────┘  │  │ │
│      │    │                                                            │  │ │
...
│                                                                              │
│      ┌─────────────────────────────────────────────────────────────────┐   │
│      │  WHAT（Capability Hierarchy = 能力階層）                         │   │
│      │                                                                  │   │
│      │      CL1: Activity Area                                          │   │
│      │           「どの活動領域か」                                      │   │
│      │                  │                                               │   │
│      │                  ▼                                               │   │
│      │      CL2: Capability = Subdomain = BC境界                        │   │
│      │           「何の能力が必要か」                                    │   │
│      │                  │                                               │   │
│      │                  ▼                                               │   │
│      │      CL3: Sub-capability                                         │   │
...
│      │  HOW（実現方法）                                                 │   │
│      │                                                                  │   │
│      │      CL2 → BC実装設計（Phase 4-5）                               │   │
│      │           「どう実装するか」                                      │   │
│      │                                                                  │   │
│      │      CL3 → BO: Business Operation                                │   │
│      │           「どう業務遂行するか」                                  │   │
│      │                                                                  │   │
│      └─────────────────────────────────────────────────────────────────┘   │
│                                                                              │
│  BizBOK: L1→L2→L3 すべてWHAT（Capability）                                │
│  V5:     CL1→CL2→CL3 すべてWHAT（能力階層）                               │
│          各レベルに対応するHOW（BO、BC実装）を分離                          │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│  BC境界（CL2）が詳細能力（CL3）とBO群を束ねる構造                           │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│  ┌───────────────────────────────────────────────────────────────────────┐ │
│  │  CL2: 決済ケイパビリティ（BC境界 / Subdomain）【WHAT】                │ │
│  │                                                                        │ │
│  │    ┌─────────────────────────────────────────────────────────────┐    │ │
│  │    │  CL3: カード決済能力 【WHAT】                                │    │ │
│  │    │    └── BO: カード決済処理オペレーション 【HOW】              │    │ │
│  │    │  CL3: 振込決済能力 【WHAT】                                  │    │ │
│  │    │    └── BO: 振込決済処理オペレーション 【HOW】                │    │ │
│  │    │  CL3: 返金管理能力 【WHAT】                                  │    │ │
│  │    │    └── BO: 返金処理オペレーション 【HOW】                    │    │ │
│  │    └─────────────────────────────────────────────────────────────┘    │ │
│  │                                                                        │ │
│  │  → CL3（詳細能力）群をまとめた境界がBC（CL2）                         │ │
│  │  → CL3の実現方法がBO（業務オペレーション）                            │ │
...
| 概念 | 位置づけ | 領域 | 説明 |
|------|---------|------|------|
| **BC境界（Subdomain）** | CL2 | WHAT | 詳細能力群を束ねた境界 |
| **Sub-capability** | CL3 | WHAT | BC内の詳細能力 |
| **Business Operation** | BO | HOW | CL3を実現するAPIエンドポイント/ユースケース |
