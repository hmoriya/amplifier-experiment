#!/usr/bin/env python3
"""
Final Parasol V5 book generator with complete markdown support
"""

import re
import json
from pathlib import Path
from final_markdown_converter import FinalMarkdownConverter


class FinalBookGenerator:
    """Final book generator with complete markdown support"""
    
    def __init__(self, book_dir: Path, output_dir: Path):
        self.book_dir = Path(book_dir)
        self.output_dir = Path(output_dir)
        self.output_dir.mkdir(exist_ok=True)
        self.converter = FinalMarkdownConverter()
    ...
    def generate_html(self):
        """Generate HTML book"""
        print("📚 Final Parasol V5 Book Generator")
        print("=" * 50)
        ...
        print(f"\n✅ Complete HTML book: {output_file}")
