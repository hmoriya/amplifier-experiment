#!/usr/bin/env python3
"""
Fixed Parasol V5 book generator with proper code block handling
"""

import re
import json
from pathlib import Path
from fixed_final_markdown_converter import FixedFinalMarkdownConverter


class FixedBookGenerator:
    """Fixed book generator with proper code block handling"""
    
    def __init__(self, book_dir: Path, output_dir: Path):
        self.book_dir = Path(book_dir)
        self.output_dir = Path(output_dir)
        self.output_dir.mkdir(exist_ok=True)
        self.converter = FixedFinalMarkdownConverter()
    ...
    def generate_html(self):
        """Generate HTML book"""
        print("📚 Fixed Parasol V5 Book Generator")
        print("=" * 50)
        ...
        # Save
        output_file = self.output_dir / 'parasol-v5-fixed.html'
        output_file.write_text(html, encoding='utf-8')
        
        print(f"\n✅ Fixed HTML book: {output_file}")
